						  ...
						  <div class="col-12 col-sm-12 col-lg-12">
							<div class="card">
								<div class="card-header header-elements-sm-inline">
			                                       <h4>{{$data->title}} Details</h4>

                                        <div class="header-elements"> 
                                            @if(auth()->user()->id == $data->user_id)               
                               <a href="{{ route("posts.edit",$data->id)}}" class="list-icons-item text-primary">
                                        <i class="fas fa-pencil"></i> Edit Post
                                                     </a>
                                             @endif

                                             &nbsp;&nbsp;&nbsp;
                                             <a href="{{ route("posts.index")}}" class="list-icons-item text-primary">
     ...
     {{-- overview --}}
		<div class="tab-pane fade show active " id="vertical-left-tab1">
                       ...
                       <table class="table datatable-overview table-striped">
                                ...
                                <tr><th>Body</th><td>{{$data->body}}</td></tr>
                                 <tr><th>Created By </th><td>{{$data->user->name}}</td></tr>
                                </tbody>
                        </table>
                    </div>
                    </div>
